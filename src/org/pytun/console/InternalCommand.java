		...
		if (tokens.length == 1) {
			...
			if (tokens[1].equals("sql")) {
				...
				if (cmd.equals("select")) {
					System.out.println("  SELECT <expr1>, <expr2>, ... [FROM <table_joins>] [WHERE <condition_expr>] [ORDER BY <expr1>, <expr2>, ...]");
				} else if (cmd.equals("update")) {
					System.out.println("  UPDATE <table_name> SET <col1> = <expr1>, <col2> = <expr2>");
				} else if (cmd.equals("insert")) {
					System.out.println("  INSERT INTO <table_name> VALUES (<val1>, <val2>, ...)");
				} else if (cmd.equals("delete")) {
					System.out.println("  DELETE FROM <table_name> [WHERE <condition_expr>]");
				} else if (cmd.equals("create")) {
					System.out.println("  CREATE TABLE <table_name> (<col1> <type1>, <col2> <type2>, ...)");
