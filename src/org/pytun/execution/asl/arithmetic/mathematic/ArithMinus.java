...
public class ArithMinus extends ArithMath {
	
	public ArithMinus(ArithNode left, ArithNode right) {
		this.left = left;
		this.right = right;
	}
	...
	public DbString evalString(String a, String b) throws Exception {
		throw new Exception ("Exec error: MINUS operator is not applicable on STRING types");
	}
